...
<div class="modal fade" id="modal-lg">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo base_url('kas/addout'); ?>">
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo base_url('kas/editout'); ?>">
                <div class="modal-body">
...
<div class="modal fade" id="modal-hapus">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo base_url('kas/hapusout'); ?>">
                <div class="modal-body">
                    <input type="hidden" id="id_hapus" name="id_hapus">
                    <div class="form-group">
                        <label>Category</label>
                        <select class="form-control" name="edit_category" id="hapus_category">
                            <option>Pilih Category....</option>
                            <?php foreach ($category as $dcat) { ?>
                                <option value="<?php echo $dcat['id_category']; ?>"><?php echo $dcat['name_category']; ?></option>
                            <?php } ?>
                    ...
                    <div class="form-group">
                        <label>Jumlah Transaksi</label>
                        <input type="text" class="form-control" id="hapus_saldo" name="edit_saldo" placeholder="Saldo">
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea class="form-control" name="edit_desc" id="hapus_desc" placeholder="Deskripsi Transaksi"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Tanggal Transaksi</label>
                        <input type="date" class="form-control" id="hapus_date" name="edit_tanggal">
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<script>
    function edit(id) {
        ...
        $.ajax({
            type: "get",
            url: "<?php echo base_url('kas/dataout/') ?>" + id,
            dataType: "json",
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            "ajax": "<?php echo base_url('kas/outdata/'); ?>"
        });
